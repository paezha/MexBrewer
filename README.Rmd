...
Mexican painters and muralists. This package draws inspiration and heavily from the code of
[{MetBrewer}](https://github.com/BlakeRMills/MetBrewer), the package with color
palettes form the Metropolitan Museum of Art of New York, created by [Blake R. Mills](https://github.com/BlakeRMills/). The structure of the package and coding, like {MetBrewer}, are based on [{PNWColors}](https://github.com/jakelawlor/PNWColors) and [{wesanderson}](https://github.com/karthik/wesanderson).
